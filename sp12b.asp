...
<%response.cookies("amenu") = "sp12b.asp"%>
<% 
...
<TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all class="hd" style="font-family: Trebuchet MS; font-size: 10pt;">
  <TBODY>
  <form name="tt" method="post" action="sp12b.asp" onSubmit="return checkCarian(this)">
...
<TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all class="hd">
  ...
  <table width="70%" border=0 cellpadding=0 cellspacing=0 align="center" style="font-family: Trebuchet MS; font-size: 10pt;">
    <tr>
	  ...
	  <% If iPageCurrent <> 1 Then %> <a href="sp12b.asp?page=1&bilangan=0&ms=pre&carian=<%=carian%>&id_unit=<%=id_unit%>"> 
        <img name="firstrec" border="0" src="images\slide_beginning_02.gif" width="21" height="21"></a> 
        <% End if %> 
		<% If iPageCurrent <> 1 Then %> 
		<a href="sp12b.asp?page=<%= iPageCurrent - 1 %>&bilangan=<%=bil-count-iPageSize%>&ms=pre&carian=<%=carian%>&id_unit=<%=id_unit%>"> 
      ...
      <td align="right" width="15%"> <% If iPageCurrent < iPageCount Then	%> 
        <a href="sp12b.asp?page=<%= iPageCurrent + 1 %>&bilangan=<%=bil%>&ms=next&carian=<%=carian%>&id_unit=<%=id_unit%>"> 
	...
	<a href="sp12b.asp?page=<%=iPageCount %>&bilangan=<%=bil%>&ms=next&carian=<%=carian%>&id_unit=<%=id_unit%>"> 
  ...
  <form name="test0" method="post" action="sp12b.asp" onSubmit="return check(this)">
    <tr valign="middle"> 
      <td>&nbsp; </td>
...
%>
  <tr> 
    ...
    <td>&nbsp;<%=oz1("nama")%></td>
    <form name="test_hapus<%=bil%>"  method="post" action="sp12b.asp">

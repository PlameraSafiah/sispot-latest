...
nama_unitedit    = request("nama_unitedit")
...
%>
  <tr> 
    ...
    <td><textarea name="nama_unitedit" cols="50" rows="1"><%=rs1("nama_unit")%></textarea></td>
...
nama_unitedit=request("nama_unitedit")
If a<>"" then
q1 = "Update payroll.unit_sispot set nama_unit = '"&nama_unitedit&"' "
q1 = q1 & "where nama_unit = '"& nama_unit &"' "
objConn.Execute(q1)
response.write q1
papar()%> 
...
<TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all class="hd">
  <TBODY> 
  <tr>
    <td align="center"> Rekod <%=nama_unit%> telah diedit.</td>
  </tr>
</tbody></table>

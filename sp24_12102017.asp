  ...
  <TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all class="hd">
    ...
    <tr align="center"> 
      <td colspan="2"><input type="submit" name="proses" value="Hantar">&nbsp;&nbsp;
       <input type="submit" name="proses" value="Senarai Pekerja Mengikut Arahan Kerja"></a></td>
    </tr>
  </table>
</form>
<%
...
sub senarai()
tkh_post_ak=request.form("tkh_post_ak")
q1="select id_ak,keterangan,kategori,keterangan_1,nota,pemohon,bulan||'/'||tahun as bulantahun from payroll.arahan_kerja where tkh_sah is null and ptj="& ptj &" "
if pemohon <> "" then
...
<TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all class="hd">
  <TBODY>
    <tr class="hd"> 
      <td colspan="12" >Senarai Arahan Kerja</td>
    </tr>
    ...
    <tr class="hd"> 
      ...
      <td align="center">Keterangan Kerja</td>

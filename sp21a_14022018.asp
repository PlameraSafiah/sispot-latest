...
set oq1 = objConn.Execute(q1)
	...
	if  oq1.eof then	 
	 ...
	 If fkategori<>"" and fketerangan<>"" and fdaerah<>"" then
...
<%	 else %>
<script language="JavaScript">
	alert("Sila lengkapkan ruangan Kategori ,Keterangan Kerja dan Daerah.");
	document.masa0.tkh.focus();
</script>
<%
end if 
...
<TR bgcolor="<%=color1%>" > 
  ...
  <select name="fketerangan" id="fketerangan" onChange="submitForm7(this)">
     ...
     zv = " select upper(keterangan) ket from payroll.keterangan_kerja where kategori = '"& ffkategori1 &"' order by ket  "

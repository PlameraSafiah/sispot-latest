<html>
<head>
<title>Cetak Arahan Kerja Keseluruhan</title>
<STYLE TYPE="text/css">
table.page-break{ 
border: none;
...
<form action="sp26a1.asp" method="POST">
...
<%Set objConn = Server.CreateObject("ADODB.Connection")
 ...
 ss = " select id_ak ,pemohon, penyelia , unit , ptj , keterangan_1,keterangan , nota , tahun , bulan , pengesahan"
 ss = ss & " from payroll.arahan_kerja where pemohon='"&pemohon&"'  and pengesahan='Y' order by id_ak asc " 
...
<tr>
  ...
  <td ><font face="Verdana" size="2"><b>&nbsp;:</b></font></td>
  <td ><font face="Verdana" size="2"><%=penyelia%>-(<%=nama1%>)</font></td>
</tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="88%">
  <tr class="hd"> 
     <td width="4%" align="center">Bil</b></td>
    <td width="22%" align="center">Tarikh</b></td>
...
<% 
 ...
 %>
   ...
   <td width="22%" align="center">&nbsp;<%=tkh_ot%></td>
...
<tr>
  ...
  <td height="30"><font face="Verdana" size="2"><b>&nbsp;Nama :</b> <%=nama1%></font></td>
</tr>
<tr>
  <td height="40"><font face="Verdana" size="2"><b>&nbsp;Jawatan :</b> <%=jaw%></font></td>
  <td height="40"><font face="Verdana" size="2"><b>&nbsp;Jawatan :</b> <%=jaw1%></font></td>
</tr>
<tr>
...
<br>
<table align="center" border="0" cellpadding="0" cellspacing="0" width="93%" class="page-break" >
<tr>

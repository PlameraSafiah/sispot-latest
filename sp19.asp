...
objConn1.Open "dsn=12c;uid=payroll;pwd=gaji;"

set rs4 = server.createobject("ADODB.Recordset")
rs4.open "select * from ptj where ( kod <> 100 and kod <> 110 and kod <> 217 and kod <> 237 and kod <> 227 and kod <> 207 and kod <> 999) order by kod  ",objConn1
%>
...
<table border="1" width="830" cellspacing="0" cellpadding="0" height="177">
	<tr>
		...
		<b>PEGAWAI PELULUS YANG TELAH DIDAFTAR</b></td>
	</tr>
	...
	<tr>
		...
		<form method="POST" action="sp19.asp">
...
rs.open "select distinct no_pekerja from kebenaran_2002 where sistem = 'sp' AND skrin = 'sp14' ",objConn
...
rs2.open "select * from paymas where no_pekerja = '"&rs("no_pekerja")&"' and lokasi = '"&request("jabatan")&"' ",objConn1

if not rs2.eof then
	b=b+1
	set rs3 = server.createobject("ADODB.Recordset")
	rs3.open "select * from ptj where kod = '"&rs2("lokasi")&"' ",objConn1

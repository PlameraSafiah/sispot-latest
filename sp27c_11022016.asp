...
<TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all class="hd" height="20%">
  <TBODY>
    ...
    <td width="9%"   align="center">No Pekerja</td>
    <td width="18%"  align="center">Nama Pekerja</td>
    <td width="14%"  align="center">Jabatan</td>
    <td width="14%"  align="center">1/3 Gaji Pokok (RM)</td>
    <td width="21%"  align="center">Anggaran OT (RM)</td>
    </tr>
...
<form name="test<%=bil%>"  method="post" action="sp27c.asp" target="_new">
  ...
  <tr bgcolor="<%=color%>">
    ...
    <td rowspan="2" align="center"><%=rsss("sepertiga")%></td>
    <td rowspan="2" align="center"><%=rse("total_ot_sebulan")%></td>
  </tr>
  <tr bgcolor="#EFF5F5">
  </tr>
      <% end if %> 

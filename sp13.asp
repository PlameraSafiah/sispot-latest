...
thn = mid(tahun,5,4)
	...
	if r0.eof then
		...
		'simpan data selenggara 1/3 ---> nadia (15032016)				
		q2="Insert all "
		if bulan1 <> "" then
...
<TABLE border=1 borderColor=black cellPadding=1 cellSpacing=0 rules=all width="48%" align="center"> 
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <input type="checkbox" name="all"  id="all" value='all' <%if all = "all" then %>checked<%end if%>><label for='all'><b>Pilih Semua</b></label>
    <br>
    <ul>
    <li>&nbsp;&nbsp;&nbsp;
    <input type="checkbox" name="bulan1" id="1" value="1" <%if bulan1 = "1" then %>checked<%end if%>><label for="1">Jan</label>    
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="checkbox" name="bulan2" id="2" value="2" <%if bulan2 = "2" then %>checked<%end if%>><label for="2">Feb</label>&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="checkbox" name="bulan3" id="3" value="3" <%if bulan3 = "3" then %>checked<%end if%>><label for="3">Mac</label>&nbsp;&nbsp;&nbsp;
    <input type="checkbox" name="bulan4" id="4" value="4" <%if bulan4 = "4" then %>checked<%end if%>><label for="4">April</label>&nbsp;&nbsp;
    <input type="checkbox" name="bulan5" id="5" value="5" <%if bulan5 = "5" then %>checked<%end if%>><label for="5">Mei</label>&nbsp;&nbsp;&nbsp;
    <input type="checkbox" name="bulan6" id="6" value="6" <%if bulan6 = "6" then %>checked<%end if%>><label for="6">Jun</label></li>
    <li>&nbsp;&nbsp;&nbsp; <input type="checkbox" name="bulan7" id="7" value="7" <%if bulan7 = "7" then %>checked<%end if%>><label for="7">Julai</label> 
    &nbsp;&nbsp;&nbsp; <input type="checkbox" name="bulan8" id="8" value="8" <%if bulan8 = "8" then %>checked<%end if%>><label for="8">Ogos</label>&nbsp;&nbsp;
    <input type="checkbox" name="bulan9" id="9" value="9" <%if bulan9 = "9" then %>checked<%end if%>><label for="9">Sept</label>&nbsp;&nbsp;
    <input type="checkbox" name="bulan10" id="10" value="10" <%if bulan10 = "10" then %>checked<%end if%>><label for="10">Okt</label>&nbsp;&nbsp;&nbsp;
    <input type="checkbox" name="bulan11" id="11" value="11" <%if bulan11 = "11" then %>checked<%end if%>><label for="11">Nov</label>&nbsp;&nbsp;
    <input type="checkbox" name="bulan12" id="12" value="12" <%if bulan12 = "12" then %>checked<%end if%>><label for="12">Dis</label></li>
    </ul>
    </li>
    <br>  
    </td>
...
tahun=request("tahun")
    ...
    'semak bulan/tahun OT - arahan kerja 
